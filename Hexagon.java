...
public class Hexagon extends HexComponent {
	...
	public static enum HexType {
		WALL, START, END, EMPTY, START_PROCESSED, END_PROCESSED, START_DEQUEUED, ENQUEUED, DEQUEUED, DRAGON, LAVA,
		CACTI, PATH, IN_PATH
	};
	 ...
	 * @param i        The index specifying which side this neighbor is on (0-5
	 *                 inclusive)
	 ...
	 * @return The hexagon that is on the i-th side of the current hexagon, or null
	 *         if no neighbor
	 * @throws InvalidNeighbourIndexException When an index is specified that is not
	 *                                        0-5 inclusive.
	 */
	 ...
	 * 
	 * @return true if this chamber has been marked as dequeued, false otherwise.
	 */
	 ...
	 * 
	 * @return true if this chamber has been marked as enqueued, false otherwise.
	 */
	...
	/**
	 * This method checks if the current Hexagon object hosts a dragon. This means
	 * that no adjacent Hexagon object can be in the path to the end
	 * 
	...
	/**
	 * This method marks the chamber as ENQUEUED and updates the chamber's colour
	 */
	...
	/**
	 * This method marks the chamber as DEQUEUED and updates the chamber's colour
	 */
	...
	/**
	 * Helper method to set the current chamber color based on the type of chamber.
	 * 
	 * @param t The type of the chamber; used to set the color
	 */
	...
	/**
	 * Returns the predicted distance from this chamber to the exit of the dungeon.
	 * The predicted distance is simply the Euclidean distance. If there is no exit
	 * to the dungeon then a distance of 0 is returned
	 * 
	 * 
	 * @param The dungeon to which the chamber belongs
	 ...
	 * this chamber
	 * 
	 * @param The estimation of the distance to the initial chamber
	 */
	 ...
	 * 
	 * @param otherChamber Hexagon reference
	...
	/**
	 * Get the preceding Hexagon object to this one in a shortest path from initial
	 * chamber to exit
	 * 
	 * @return preceding Hexagon object in the shortest path from initial chamber to
	 *         destination
	 */
	 ...
	 * 
	 * @param pred: preceding Hexagon object to this one in a shortest path from the
	 *              initial chamer to the exit
	 */
